...
export function serializeProduct(doc) {
  ...
  return {
    ...
    weights: {
      gross: {
        k18: doc.weights?.gross?.k18 || 0,
        k14: doc.weights?.gross?.k14 || 0,
        k9: doc.weights?.gross?.k9 || 0,
      },
      net: {
        k18: doc.weights?.net?.k18 || 0,
        k14: doc.weights?.net?.k14 || 0,
        k9: doc.weights?.net?.k9 || 0,
      },
      diamond: doc.weights?.diamond || 0,
      colourStone: doc.weights?.colourStone || 0,
    },
